    ...
    <main>
      ...
      <div className="w-full h-screen flex items-center justify-center">
        <div className="w-3/4 text-center text-xl space-y-1">
          <p>This site itself! It works in mobile and desktop, it is fast and very beatifull. That really makes me proud of it! You can see it&apos; <a target="_blank" href="https://github.com/aikooo7/portfolio">source code here</a></p>
